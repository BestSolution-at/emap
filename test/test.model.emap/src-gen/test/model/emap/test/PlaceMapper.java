...
public interface PlaceMapper extends at.bestsolution.persistence.ObjectMapper<test.model.test.Place> {
	...
	// by KeyGenerator
	final static at.bestsolution.persistence.java.KeyLayout<PlaceMapper.Key> PKLayout = new at.bestsolution.persistence.java.KeyLayout<PlaceMapper.Key>(
		new at.bestsolution.persistence.java.KeyLayout.KeyLayoutEntry("id", "ID", long.class)) {
		@Override
		public PlaceMapper.Key create(Map<String, Object> values) {
	...
	// by KeyGenerator
	final static class KeyImpl extends at.bestsolution.persistence.java.AMapBasedKey<Place> implements PlaceMapper.Key {
		KeyImpl(Map<String, Object> values) {
			super(Place.class, values);
		}
		
		@Override
		public at.bestsolution.persistence.java.KeyLayout<PlaceMapper.Key> getKeyLayout() {
		...
		public String toString() {
			return "Key(Place, " + super.toString() + ")";
		}
	}
	...
	public java.util.List<test.model.test.Place> selectAllForPerson(long personId);
		...
		public static final class Expression {
			...
			public static final at.bestsolution.persistence.expr.PropertyExpressionFactory.EntityExpressionFactory<Place, Place> Place_self_obj() {
					return self_obj();
			}
