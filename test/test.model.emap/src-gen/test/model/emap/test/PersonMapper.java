...
public interface PersonMapper extends at.bestsolution.persistence.ObjectMapper<test.model.test.Person> {
	...
	// by KeyGenerator
	final static at.bestsolution.persistence.java.KeyLayout<PersonMapper.Key> PKLayout = new at.bestsolution.persistence.java.KeyLayout<PersonMapper.Key>(
		new at.bestsolution.persistence.java.KeyLayout.KeyLayoutEntry("id", "ID", long.class)) {
		@Override
		public PersonMapper.Key create(Map<String, Object> values) {
	...
	// by KeyGenerator
	final static class KeyImpl extends at.bestsolution.persistence.java.AMapBasedKey<Person> implements PersonMapper.Key {
		KeyImpl(Map<String, Object> values) {
			super(Person.class, values);
		}
		
		@Override
		public at.bestsolution.persistence.java.KeyLayout<PersonMapper.Key> getKeyLayout() {
		...
		public String toString() {
			return "Key(Person, " + super.toString() + ")";
		}
	}
	...
	public java.util.List<test.model.test.Person> selectAllForPlace(long placeId);
		...
		public static final class Expression {
			...
			public static final at.bestsolution.persistence.expr.PropertyExpressionFactory.EntityExpressionFactory<Person, Person> Person_self_obj() {
					return self_obj();
			}
			...
			public static final at.bestsolution.persistence.expr.PropertyExpressionFactory.EntityExpressionFactory<Person,test.model.test.Address> addresses_obj() {
				return new at.bestsolution.persistence.expr.PropertyExpressionFactory.EntityExpressionFactory<Person,test.model.test.Address>("addresses."+addresses().id().getProperty()) {
					...
					//}
					@Override
					protected <K extends at.bestsolution.persistence.Key<test.model.test.Address>> K getKey(test.model.test.Address o) {
						// TODO howto create an instance of the key here within the interface -.-
						return null;
					}
				};
			...
			public static final at.bestsolution.persistence.expr.PropertyExpressionFactory.EntityExpressionFactory<Person,test.model.test.Place> likes_obj() {
				return new at.bestsolution.persistence.expr.PropertyExpressionFactory.EntityExpressionFactory<Person,test.model.test.Place>("likes."+likes().id().getProperty()) {
					...
					//}
					@Override
					protected <K extends at.bestsolution.persistence.Key<test.model.test.Place>> K getKey(test.model.test.Place o) {
						// TODO howto create an instance of the key here within the interface -.-
						return null;
					}
				};
