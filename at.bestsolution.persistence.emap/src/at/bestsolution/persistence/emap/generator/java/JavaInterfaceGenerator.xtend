...
class JavaInterfaceGenerator {
	...
	val generatorCredit = '''generated by «getClass.simpleName»'''
	...
	public interface «entityDef.entity.name»Mapper extends «IF entityDef.entity.namedQueries.findFirst[name == "selectAll" && parameters.empty] != null»at.bestsolution.persistence.ConcreteObjectMapper<«eClass.instanceClassName»,at.bestsolution.persistence.MappedQuery<«eClass.name»>>«ELSE»at.bestsolution.persistence.ObjectMapper<«eClass.instanceClassName»>«ENDIF» {
		...
		// «generatorCredit»
		public static interface Key extends at.bestsolution.persistence.Key<«eClass.name»> {
			«FOR pk : entityDef.findPKAttributes»
			public «pk.getEAttribute(eClass).EType.instanceClassName» «pk.name»();
			«ENDFOR»
		}
		
		«keyGenerator.generatePrimaryKeyLayout(entityDef, eClass)»
		
		«FOR reference : entityDef.entity.collectAllAttributes.filter[isSingle(eClass) && resolved]»
		«keyGenerator.generateForeignKeyLayout(entityDef, eClass, reference)»
		«ENDFOR»
		
		«keyGenerator.generateKeyImpl(entityDef, eClass)»
...
«««			}
			...
			public static final class Expression {
				public static final at.bestsolution.persistence.expr.PropertyExpressionFactory.EntityExpressionFactory<«eClass.name», «eClass.name»> self_obj() {
					return new at.bestsolution.persistence.expr.PropertyExpressionFactory.EntityExpressionFactory<«eClass.name», «eClass.name»>("«pk.name»") {
						@Override
						protected <K extends at.bestsolution.persistence.Key<«eClass.name»>> K getKey(«eClass.name» o) {
				...
				public static final at.bestsolution.persistence.expr.PropertyExpressionFactory.EntityExpressionFactory<«eClass.name», «eClass.name»> «entityDef.entity.name»_self_obj() {
						return self_obj();
				}
...
«««					«println(a)»
					«IF a.resolved»
						...
						«val oppositeEClass = ((a.query.eResource.contents.head as EMapping).root as EMappingEntityDef).entity.lookupEClass»
						/**
						...
						public static final at.bestsolution.persistence.expr.PropertyExpressionFactory.EntityExpressionFactory<«eClass.name»,«oppositeEClass.instanceClassName»> «a.name.javaReservedNameEscape»_obj() {
							return new at.bestsolution.persistence.expr.PropertyExpressionFactory.EntityExpressionFactory<«eClass.name»,«((a.query.eResource.contents.head as EMapping).root as EMappingEntityDef).entity.lookupEClass.instanceClassName»>("«a.name»") {
								@Override
								protected <K extends at.bestsolution.persistence.Key<«oppositeEClass.instanceClassName»>> K getKey(«oppositeEClass.instanceClassName» o) {
									// TODO howto create an instance of the key here within the interface -.-
									return null;
								}
							};
						...
						«ELSE»
						«val otherEClass = ((a.query.eResource.contents.head as EMapping).root as EMappingEntityDef).entity.lookupEClass»
«««						public static final at.bestsolution.persistence.expr.PropertyExpressionFactory.LongExpressionFactory<«eClass.name»> «a.name.javaReservedNameEscape»_sid() { return «a.name.javaReservedNameEscape»().«((a.query.eResource.contents.head as EMapping).root as EMappingEntityDef).entity.PKAttribute.name»(); };
						public static final at.bestsolution.persistence.expr.PropertyExpressionFactory.EntityExpressionFactory<«eClass.name»,«otherEClass.instanceClassName»> «a.name.javaReservedNameEscape»_obj() {
							return new at.bestsolution.persistence.expr.PropertyExpressionFactory.EntityExpressionFactory<«eClass.name»,«otherEClass.instanceClassName»>("«a.name»."+«a.name.javaReservedNameEscape»().«((a.query.eResource.contents.head as EMapping).root as EMappingEntityDef).entity.PKAttribute.name»().getProperty()) {
								//protected long getSid(«otherEClass.instanceClassName» value) {
								...
								//}
								@Override
								protected <K extends at.bestsolution.persistence.Key<«otherEClass.instanceClassName»>> K getKey(«otherEClass.instanceClassName» o) {
									// TODO howto create an instance of the key here within the interface -.-
									return null;
								}
							};
