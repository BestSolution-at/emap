...
public class TablePackageImpl extends EPackageImpl implements TablePackage {
	 ...
	 * @see at.bestsolution.persistence.emap.model.table.TablePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getTable_LockColumn() {
	 ...
	 * @generated
	 */
	public EAttribute getColumn_DataTypeSize() {
	 ...
	 * @generated
	 */
	public EReference getForeignKey_RefKey() {
	 ...
	 * @generated
	 */
	public EReference getTableModel_Tables() {
	 ...
	 * @generated
	 */
	public EReference getTableModel_NmTables() {
	 ...
	 * @generated
	 */
	public EReference getTableModel_MappedBundle() {
		return (EReference)tableModelEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEReference(foreignKeyEClass, FOREIGN_KEY__REF_KEY);
		createEReference(foreignKeyEClass, FOREIGN_KEY__COLUMNS);

		tableModelEClass = createEClass(TABLE_MODEL);
		createEReference(tableModelEClass, TABLE_MODEL__TABLES);
		createEReference(tableModelEClass, TABLE_MODEL__NM_TABLES);
		createEReference(tableModelEClass, TABLE_MODEL__MAPPED_BUNDLE);
	...
	public void initializePackageContents() {
		...
		EMapPackage theEMapPackage = (EMapPackage)EPackage.Registry.INSTANCE.getEPackage(EMapPackage.eNS_URI);
		...
		initEReference(getTable_Key(), this.getPrimaryKey(), this.getPrimaryKey_Table(), "key", null, 0, 1, Table.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTable_LockColumn(), this.getColumn(), null, "lockColumn", null, 0, 1, Table.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getColumn_DataType(), theEcorePackage.getEDataType(), null, "dataType", null, 0, 1, Column.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getColumn_DataTypeSize(), theEcorePackage.getEString(), "dataTypeSize", null, 0, 1, Column.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getColumn_NotNull(), theEcorePackage.getEBoolean(), "notNull", null, 0, 1, Column.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(primaryKeyEClass, PrimaryKey.class, "PrimaryKey", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPrimaryKey_Table(), this.getTable(), this.getTable_Key(), "table", null, 0, 1, PrimaryKey.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getForeignKey_Table(), this.getTable(), this.getTable_ForeignKeys(), "table", null, 0, 1, ForeignKey.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getForeignKey_RefKey(), this.getPrimaryKey(), null, "refKey", null, 0, 1, ForeignKey.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTableModel_Tables(), this.getTable(), null, "tables", null, 0, -1, TableModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTableModel_NmTables(), this.getTable(), null, "nmTables", null, 0, -1, TableModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTableModel_MappedBundle(), theEMapPackage.getEMappingBundle(), null, "mappedBundle", null, 0, 1, TableModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
