...
public class SamplePackageImpl extends EPackageImpl implements SamplePackage {
	 ...
	 * @generated
	 */
	private EClass contactBookEClass = null;
	 ...
	 * @generated
	 */
	public EClass getContactBook() {
		return contactBookEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getContactBook_PersonList() {
		return (EReference)contactBookEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getPerson_AddressList() {
	...
	public void createPackageContents() {
		...
		contactBookEClass = createEClass(CONTACT_BOOK);
		createEReference(contactBookEClass, CONTACT_BOOK__PERSON_LIST);

		personEClass = createEClass(PERSON);
		createEAttribute(personEClass, PERSON__LASTNAME);
		createEAttribute(personEClass, PERSON__FIRSTNAME);
		createEReference(personEClass, PERSON__ADDRESS_LIST);
	...
	public void initializePackageContents() {
		...
		contactBookEClass.getESuperTypes().add(this.getBaseObject());
		personEClass.getESuperTypes().add(this.getBaseObject());
		addressEClass.getESuperTypes().add(this.getBaseObject());
		...
		initEAttribute(getBaseObject_Id(), ecorePackage.getELong(), "id", null, 0, 1, BaseObject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(contactBookEClass, ContactBook.class, "ContactBook", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getContactBook_PersonList(), this.getPerson(), null, "personList", null, 0, -1, ContactBook.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getPerson_AddressList(), this.getAddress(), this.getAddress_Person(), "addressList", null, 0, -1, Person.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getAddress_Person(), this.getPerson(), this.getPerson_AddressList(), "person", null, 0, 1, Address.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
