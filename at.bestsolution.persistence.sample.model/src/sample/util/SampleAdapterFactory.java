...
public class SampleAdapterFactory extends AdapterFactoryImpl {
	...
	protected SampleSwitch<Adapter> modelSwitch =
		new SampleSwitch<Adapter>() {
			...
			@Override
			public Adapter caseContactBook(ContactBook object) {
				return createContactBookAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link sample.BaseObject <em>Base Object</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link sample.ContactBook <em>Contact Book</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createContactBookAdapter() {
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link sample.Address <em>Address</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link sample.Country <em>Country</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
