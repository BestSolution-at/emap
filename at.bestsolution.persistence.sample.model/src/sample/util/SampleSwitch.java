...
public class SampleSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SamplePackage.CONTACT_BOOK: {
				ContactBook contactBook = (ContactBook)theEObject;
				T result = caseContactBook(contactBook);
				if (result == null) result = caseBaseObject(contactBook);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case SamplePackage.ADDRESS: {
				Address address = (Address)theEObject;
				T result = caseAddress(address);
				if (result == null) result = caseBaseObject(address);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Contact Book</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Contact Book</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseContactBook(ContactBook object) {
		return null;
	}
