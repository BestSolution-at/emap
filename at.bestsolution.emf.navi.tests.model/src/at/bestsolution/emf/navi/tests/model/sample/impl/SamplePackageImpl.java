...
import at.bestsolution.emf.navi.tests.model.sample.SampleFactory;
...
public class SamplePackageImpl extends EPackageImpl implements SamplePackage {
	 ...
	 * @see at.bestsolution.emf.navi.tests.model.sample.SamplePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getDepartment_Groups() {
	 ...
	 * @generated
	 */
	public EReference getGroup_Department() {
	...
	public void initializePackageContents() {
		...
		initEReference(getDepartment_Groups(), this.getGroup(), this.getGroup_Department(), "groups", null, 0, -1, Department.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getGroup_Persons(), this.getPerson(), this.getPerson_Group(), "persons", null, 0, -1, Group.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getGroup_Department(), this.getDepartment(), this.getDepartment_Groups(), "department", null, 0, 1, Group.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getPerson_Group(), this.getGroup(), this.getGroup_Persons(), "group", null, 0, 1, Person.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
