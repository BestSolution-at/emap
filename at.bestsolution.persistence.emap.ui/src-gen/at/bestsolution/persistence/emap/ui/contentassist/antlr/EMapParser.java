		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getEMappingBundleAccess().getGroup_8(), "rule__EMappingBundle__Group_8__0");
					put(grammarAccess.getEMappingBundleAccess().getGroup_10(), "rule__EMappingBundle__Group_10__0");
					put(grammarAccess.getEMappingBundleAccess().getGroup_10_2(), "rule__EMappingBundle__Group_10_2__0");
					...
					put(grammarAccess.getEMappingBundleAccess().getGeneratorsAssignment_8_2(), "rule__EMappingBundle__GeneratorsAssignment_8_2");
					put(grammarAccess.getEMappingBundleAccess().getDatabasesAssignment_10_1(), "rule__EMappingBundle__DatabasesAssignment_10_1");
					put(grammarAccess.getEMappingBundleAccess().getDatabasesAssignment_10_2_1(), "rule__EMappingBundle__DatabasesAssignment_10_2_1");
					put(grammarAccess.getEMappingBundleAccess().getColSortAssignment_11_1(), "rule__EMappingBundle__ColSortAssignment_11_1");
