		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getEPredefAccess().getAlternatives(), "rule__EPredef__Alternatives");
					put(grammarAccess.getEGeneratorConfigValueAccess().getAlternatives_2(), "rule__EGeneratorConfigValue__Alternatives_2");
					...
					put(grammarAccess.getEMappingBundleAccess().getGroup_5_3(), "rule__EMappingBundle__Group_5_3__0");
					...
					put(grammarAccess.getEMappingBundleAccess().getGroup_11(), "rule__EMappingBundle__Group_11__0");
					put(grammarAccess.getEMappingBundleAccess().getGroup_11_2(), "rule__EMappingBundle__Group_11_2__0");
					put(grammarAccess.getEMappingBundleAccess().getGroup_12(), "rule__EMappingBundle__Group_12__0");
					put(grammarAccess.getEPredefAccess().getGroup_0(), "rule__EPredef__Group_0__0");
					put(grammarAccess.getEPredefAccess().getGroup_1(), "rule__EPredef__Group_1__0");
					put(grammarAccess.getEGeneratorDefAccess().getGroup(), "rule__EGeneratorDef__Group__0");
					put(grammarAccess.getEGeneratorDefAccess().getGroup_1(), "rule__EGeneratorDef__Group_1__0");
					put(grammarAccess.getEGeneratorConfigValueAccess().getGroup(), "rule__EGeneratorConfigValue__Group__0");
					put(grammarAccess.getEGeneratorConfigValueAccess().getGroup_2_1(), "rule__EGeneratorConfigValue__Group_2_1__0");
					...
					put(grammarAccess.getERestServiceMappingAccess().getGroup(), "rule__ERestServiceMapping__Group__0");
					...
					put(grammarAccess.getEMappingBundleAccess().getEntitiesAssignment_6(), "rule__EMappingBundle__EntitiesAssignment_6");
					put(grammarAccess.getEMappingBundleAccess().getEntitiesAssignment_7_1(), "rule__EMappingBundle__EntitiesAssignment_7_1");
					put(grammarAccess.getEMappingBundleAccess().getTypeDefsAssignment_8(), "rule__EMappingBundle__TypeDefsAssignment_8");
					put(grammarAccess.getEMappingBundleAccess().getGeneratorsAssignment_9_2(), "rule__EMappingBundle__GeneratorsAssignment_9_2");
					put(grammarAccess.getEMappingBundleAccess().getDatabasesAssignment_11_1(), "rule__EMappingBundle__DatabasesAssignment_11_1");
					put(grammarAccess.getEMappingBundleAccess().getDatabasesAssignment_11_2_1(), "rule__EMappingBundle__DatabasesAssignment_11_2_1");
					put(grammarAccess.getEMappingBundleAccess().getColSortAssignment_12_1(), "rule__EMappingBundle__ColSortAssignment_12_1");
					put(grammarAccess.getEPredefAccess().getNameAssignment_0_2(), "rule__EPredef__NameAssignment_0_2");
					put(grammarAccess.getEPredefAccess().getNameAssignment_1_2(), "rule__EPredef__NameAssignment_1_2");
					put(grammarAccess.getEGeneratorDefAccess().getNameAssignment_0(), "rule__EGeneratorDef__NameAssignment_0");
					put(grammarAccess.getEGeneratorDefAccess().getParametersAssignment_1_1(), "rule__EGeneratorDef__ParametersAssignment_1_1");
					put(grammarAccess.getEGeneratorConfigValueAccess().getKeyAssignment_0(), "rule__EGeneratorConfigValue__KeyAssignment_0");
					put(grammarAccess.getEGeneratorConfigValueAccess().getSimpleValueAssignment_2_0(), "rule__EGeneratorConfigValue__SimpleValueAssignment_2_0");
					...
					put(grammarAccess.getEBundleEntityAccess().getRestAssignment_1_6(), "rule__EBundleEntity__RestAssignment_1_6");
