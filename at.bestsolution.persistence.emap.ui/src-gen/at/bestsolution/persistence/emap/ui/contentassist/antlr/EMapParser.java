		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getEServiceMappingAccess().getAlternatives_4_1(), "rule__EServiceMapping__Alternatives_4_1");
					put(grammarAccess.getEServiceMappingAccess().getAlternatives_5_1(), "rule__EServiceMapping__Alternatives_5_1");
					put(grammarAccess.getEServiceParamAccess().getAlternatives(), "rule__EServiceParam__Alternatives");
					...
					put(grammarAccess.getEParameterAccess().getAlternatives_1(), "rule__EParameter__Alternatives_1");
					...
					put(grammarAccess.getEServiceMappingAccess().getGroup(), "rule__EServiceMapping__Group__0");
					put(grammarAccess.getEServiceMappingAccess().getGroup_4(), "rule__EServiceMapping__Group_4__0");
					put(grammarAccess.getEServiceMappingAccess().getGroup_5(), "rule__EServiceMapping__Group_5__0");
					put(grammarAccess.getEServiceMappingAccess().getGroup_6(), "rule__EServiceMapping__Group_6__0");
					put(grammarAccess.getEServiceMappingAccess().getGroup_7(), "rule__EServiceMapping__Group_7__0");
					put(grammarAccess.getEServiceMappingAccess().getGroup_8(), "rule__EServiceMapping__Group_8__0");
					put(grammarAccess.getENamedServiceQueryAccess().getGroup(), "rule__ENamedServiceQuery__Group__0");
					put(grammarAccess.getENamedServiceQueryAccess().getGroup_3(), "rule__ENamedServiceQuery__Group_3__0");
					put(grammarAccess.getEPathParamAccess().getGroup(), "rule__EPathParam__Group__0");
					put(grammarAccess.getEPathParamAccess().getGroup_2(), "rule__EPathParam__Group_2__0");
					put(grammarAccess.getEQueryParamAccess().getGroup(), "rule__EQueryParam__Group__0");
					put(grammarAccess.getEQueryParamAccess().getGroup_2(), "rule__EQueryParam__Group_2__0");
					...
					put(grammarAccess.getEParameterAccess().getGroup_1_1(), "rule__EParameter__Group_1_1__0");
					...
					put(grammarAccess.getEServiceMappingAccess().getPackageAssignment_0(), "rule__EServiceMapping__PackageAssignment_0");
					put(grammarAccess.getEServiceMappingAccess().getEntityAssignment_2(), "rule__EServiceMapping__EntityAssignment_2");
					put(grammarAccess.getEServiceMappingAccess().getListAssignment_4_0(), "rule__EServiceMapping__ListAssignment_4_0");
					put(grammarAccess.getEServiceMappingAccess().getListQueryAssignment_4_1_1(), "rule__EServiceMapping__ListQueryAssignment_4_1_1");
					put(grammarAccess.getEServiceMappingAccess().getGetAssignment_5_0(), "rule__EServiceMapping__GetAssignment_5_0");
					put(grammarAccess.getEServiceMappingAccess().getGetQueryAssignment_5_1_1(), "rule__EServiceMapping__GetQueryAssignment_5_1_1");
					put(grammarAccess.getEServiceMappingAccess().getUpdateAssignment_6_0(), "rule__EServiceMapping__UpdateAssignment_6_0");
					put(grammarAccess.getEServiceMappingAccess().getInsertAssignment_7_0(), "rule__EServiceMapping__InsertAssignment_7_0");
					put(grammarAccess.getEServiceMappingAccess().getDeleteAssignment_8_0(), "rule__EServiceMapping__DeleteAssignment_8_0");
					put(grammarAccess.getEServiceMappingAccess().getServiceMethodsAssignment_9(), "rule__EServiceMapping__ServiceMethodsAssignment_9");
					put(grammarAccess.getENamedServiceQueryAccess().getQueryAssignment_0(), "rule__ENamedServiceQuery__QueryAssignment_0");
					put(grammarAccess.getENamedServiceQueryAccess().getPathAssignment_2(), "rule__ENamedServiceQuery__PathAssignment_2");
					put(grammarAccess.getENamedServiceQueryAccess().getParametersAssignment_3_1(), "rule__ENamedServiceQuery__ParametersAssignment_3_1");
					put(grammarAccess.getEPathParamAccess().getParamAssignment_1(), "rule__EPathParam__ParamAssignment_1");
					put(grammarAccess.getEPathParamAccess().getNameAssignment_2_1(), "rule__EPathParam__NameAssignment_2_1");
					put(grammarAccess.getEQueryParamAccess().getParamAssignment_1(), "rule__EQueryParam__ParamAssignment_1");
					put(grammarAccess.getEQueryParamAccess().getNameAssignment_2_1(), "rule__EQueryParam__NameAssignment_2_1");
					...
					put(grammarAccess.getEParameterAccess().getTypeAssignment_1_0(), "rule__EParameter__TypeAssignment_1_0");
					put(grammarAccess.getEParameterAccess().getListAssignment_1_1_0(), "rule__EParameter__ListAssignment_1_1_0");
					put(grammarAccess.getEParameterAccess().getTypeAssignment_1_1_1(), "rule__EParameter__TypeAssignment_1_1_1");
