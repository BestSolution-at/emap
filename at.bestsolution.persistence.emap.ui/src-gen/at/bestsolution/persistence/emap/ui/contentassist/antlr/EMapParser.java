		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getEMappingEntityAccess().getGroup_8(), "rule__EMappingEntity__Group_8__0");
					put(grammarAccess.getEMappingEntityAccess().getGroup_8_1(), "rule__EMappingEntity__Group_8_1__0");
					put(grammarAccess.getEMappingEntityAccess().getGroup_10(), "rule__EMappingEntity__Group_10__0");
					put(grammarAccess.getEMappingEntityAccess().getGroup_10_3(), "rule__EMappingEntity__Group_10_3__0");
					put(grammarAccess.getEMappingEntityAccess().getGroup_12(), "rule__EMappingEntity__Group_12__0");
					...
					put(grammarAccess.getEMappingEntityAccess().getAttributesAssignment_8_0(), "rule__EMappingEntity__AttributesAssignment_8_0");
					put(grammarAccess.getEMappingEntityAccess().getAttributesAssignment_8_1_1(), "rule__EMappingEntity__AttributesAssignment_8_1_1");
					put(grammarAccess.getEMappingEntityAccess().getNamedQueriesAssignment_10_2(), "rule__EMappingEntity__NamedQueriesAssignment_10_2");
					put(grammarAccess.getEMappingEntityAccess().getNamedQueriesAssignment_10_3_1(), "rule__EMappingEntity__NamedQueriesAssignment_10_3_1");
					put(grammarAccess.getEMappingEntityAccess().getTableNameAssignment_12_1(), "rule__EMappingEntity__TableNameAssignment_12_1");
