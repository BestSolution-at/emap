...
:
(
{ before(grammarAccess.getENamedCustomQueryAccess().getRightCurlyBracketKeyword_5()); }

	'}' 

{ after(grammarAccess.getENamedCustomQueryAccess().getRightCurlyBracketKeyword_5()); }
)
