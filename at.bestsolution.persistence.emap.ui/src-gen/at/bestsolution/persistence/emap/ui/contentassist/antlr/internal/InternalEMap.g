...
:
(
{ before(grammarAccess.getEParameterAccess().getTypeEPrimtiveTypeParserRuleCall_1_0()); }
	ruleEPrimtiveType{ after(grammarAccess.getEParameterAccess().getTypeEPrimtiveTypeParserRuleCall_1_0()); }
)
